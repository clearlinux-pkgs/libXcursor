...
Version  : 1.2.3
Release  : 25
URL      : https://www.x.org/releases/individual/lib/libXcursor-1.2.3.tar.gz
Source0  : https://www.x.org/releases/individual/lib/libXcursor-1.2.3.tar.gz
Source1  : https://www.x.org/releases/individual/lib/libXcursor-1.2.3.tar.gz.sig
...
%setup -q -n libXcursor-1.2.3
cd %{_builddir}/libXcursor-1.2.3
pushd ..
cp -a libXcursor-1.2.3 build32
popd
pushd ..
cp -a libXcursor-1.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736812950
