...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649018791
...
cp %{_builddir}/libXcursor-1.2.1/COPYING %{buildroot}/usr/share/package-licenses/libXcursor/dc664605fdc1798afd260114aa223682b7d810cd
pushd ../build32/
%make_install32
